...
dir_path='./'
result_file='result_grid_mutag_GW_test.csv'
...
tuned_parameters = [{'epsilon':list(np.linspace(50,100,1))
...
clf = GridSearchCV(wgw_1NN, tuned_parameters, cv=n_splits,verbose=1,scoring='accuracy')
